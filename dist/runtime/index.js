  ...
  */
  ...
  var Element = /*#__PURE__*/function () {
    ...
    _createClass(Element, [{
      ...
      value: function set_attributes(attrs) {
        ...
        var _loop = function _loop() {
          ...
          if (key.startsWith("on") && typeof value == "function") {
            _this2._element.addEventListener(key.replace('on', '').toLowerCase(), value);

            _this2._eventListeners.push({
              fn: value,
              e: key.replace('on', '').toLowerCase()
            });
          } else {
            if (value.subscribe !== undefined) {
              _this2._element.setAttribute(key, value.get());

              _this2._updateListeners.add(value.subscribe(function (new_val, old_val) {
                _newArrowCheck(this, _this3);

                _this2._element.setAttribute(key, new_val);
              }.bind(this)).bind(_this2));
            } else {
              _this2._element.setAttribute(key, value);
            }
          }
        };
      ...
      key: "mount",
      value: function () {
        var _mount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(root) {
          var before,
              _iterator,
              _step,
              child,
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  before = _args.length > 1 && _args[1] !== undefined ? _args[1] : false;
                  //console.log(root);
      ...
      key: "destroy",
      value: function () {
        var _destroy = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  ...
  var For = /*#__PURE__*/function () {
    ...
    _createClass(For, [{
      ...
      key: "mount",
      value: function () {
        var _mount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(root) {
          var i,
              output,
              _i;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.t0 = regeneratorRuntime.keys(this._array.value);
                ...
                case 12:
                  _context2.t2 = regeneratorRuntime.keys(this._children);
                ...
                case 13:
                  ...
                  set_current_component(this.$parent);
                  _context2.next = 18;
                  return this._children[_i].mount(this._anchor, true);
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return _this.mount(options.mount);
        ...
        var _mount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(root) {
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  before = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : false;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 3:
                  ...
                  _iterator2 = _createForOfIteratorHelper(this._childrenElements);
                  _context3.prev = 5;
